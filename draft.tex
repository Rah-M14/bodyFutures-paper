...
\usepackage{float}
\usepackage{titlesec}
\titlespacing*{\section}{0pt}{4pt plus 2pt minus 2pt}{3pt plus 1pt minus 1pt}
...
Critically, this only works because the shaping signal is \emph{predictive}: a reactive penalty penalises after the fact, too late to prevent the compounding degradation that the IWM anticipates steps ahead.
