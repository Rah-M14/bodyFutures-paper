...
Evaluated on BodyFutures-Bench, PPO-IWM achieves \textbf{zero collapse} across all environments (versus 38--88\% for all baselines), a \textbf{379-step advance warning} of impending body failure (Interoceptive Anticipation Horizon; IAH\,=\,0 for every reactive and recurrent baseline), and \textbf{10.7\% higher task reward} relative to the task-only policy --- driven entirely by emergent torque efficiency with no speed increase. This Pareto-dominance holds simultaneously across task performance, body health, and collapse rate, replicated across four robot morphologies.
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.99\linewidth]{figures/b_methoidology.png}
