...
\usepackage{float}
\usepackage{titlesec}
\titlespacing*{\section}{0pt}{8pt plus 3pt minus 2pt}{4pt plus 2pt minus 1pt}
...
Extended evidence is collected in the appendix: survival comparisons, training curves, and per-joint torque analysis (Appendix~\ref{app:results}); cross-environment per-seed breakdowns with observability scope validation (Table~\ref{tab:multienv}, Appendix~\ref{app:scope}); ablation bar charts and full ablation table (Table~\ref{tab:ablations}, Appendix~\ref{app:ablations}); and checkpoint selection via Pareto-dominance over task reward, FAC, and survival (Appendix~\ref{app:hyperparams}).
