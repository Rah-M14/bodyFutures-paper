...
Cross-environment scope validation: Table~\ref{tab:multienv} (Appendix~\ref{app:scope}).
...
Survival comparisons and per-joint torque analysis: Figures~\ref{fig:survival},~\ref{fig:torque_violin},~\ref{fig:ctrl_fac_scatter} (Appendix~\ref{app:results}). Cross-environment per-seed data: Table~\ref{tab:multienv} (Appendix~\ref{app:scope}). Ablation bar charts and full table: Figures~\ref{fig:ablation},~\ref{fig:ablationcurves}, Table~\ref{tab:ablations} (Appendix~\ref{app:ablations}).
...
\bottomrule
\end{tabular}}
\raggedright\footnotesize{IWM uniquely combines endogenous degradation, multi-horizon interoceptive prediction, a deployable IAH safety metric, and online adaptation - no prior work satisfies all five criteria simultaneously.
...
See Figure~\ref{fig:fac_heatmap} in Appendix~\ref{app:training}.
